...
<h2 className="text-3xl font-bold text-gray-100 mt-2">Build Successful</h2>
...
<p className="text-gray-400 mt-2 text-sm">All generated SKUs have been added to the build history below.</p>
</div>
);
};
