...
<div>
<h1 className="text-2xl font-bold text-gray-200 tracking-tight">Römer-Ciph v1.0</h1>
<p className="text-sm text-green-400/80 -mt-1">The hidden layer that names the build.</p>
</div>
</div>
</div>
</div>
